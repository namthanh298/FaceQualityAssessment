...
def _get_patches_generic(img, patch_size, is_train, stride):
    ...
    img2 = np.resize(img, (int(w * 0.5), int(h * 0.5)))
...
if __name__ == "__main__":
    ...
    print('NIQE of ref bikes image is: %0.3f'% calc_niqe(ref))
    print('NIQE of dis bikes image is: %0.3f'% calc_niqe(dis))
    ...
    print('NIQE of ref parrot image is: %0.3f'% calc_niqe(ref))
    print('NIQE of dis parrot image is: %0.3f'% calc_niqe(dis))
